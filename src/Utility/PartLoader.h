...
{
    ModelGroup group;
    std::vector<ngl_object *>
        models;       // Supports multiple objects in an obj, such as flags on capsules, handrails and such
...
class PartLoader
{
  public:
    ...
    std::vector<std::string> list_categories = {"Command",  "Control",      "Storage", "Engine",
                                                "Coupling", "Aerodynamics", "Power",   "Utility"};
